            ...
            {showResult ? (
              ...
              <div className='mt-50'>
                ...
                <div className='flex items-center justify-center mt-30 text-3xl font-bold'>
                  <button onClick={() => handleAnswer(true)} className="cursor-pointer bg-blue-600 mx-30 py-10 px-30 w-200 rounded-xl hover:bg-blue-shadow transition-colors duration-200">
                    Dobrze
                  </button>
                  <button onClick={() => handleAnswer(false)} className="cursor-pointer bg-blue-600 mx-30 py-10 px-30 w-200 rounded-xl hover:bg-blue-shadow transition-colors duration-200">
                    Źle
                  </button>
                </div>
              </div>
